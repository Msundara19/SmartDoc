  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex items-center gap-3 px-5 py-3 border-b border-border bg-surface-1 shrink-0">
        ...
        <div className="hidden sm:flex items-center gap-1.5 text-[11px] text-accent-green border border-accent-green/30 bg-accent-green/10 px-2 py-0.5 rounded-full">
        ...
        {history.map((qa, i) => (
          <div key={i} className="space-y-2 animate-slide-up">
            ...
            <div className="flex justify-end">
              <div className="max-w-[85%] sm:max-w-xl bg-surface-3 border border-border rounded-2xl rounded-tr-sm px-4 py-2.5 text-sm text-gray-100">
                {qa.question}
              </div>
            </div>
      ...
      {/* Input bar */}
      <div className="shrink-0 px-3 sm:px-5 py-3 sm:py-4 border-t border-border bg-surface-1">
